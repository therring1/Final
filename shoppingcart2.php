 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="shoppingcart2.php"</script>';  
           }  
      }  
      else  
      {  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="shoppingcart2.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
          ...
          <div style="clear:both"></div>  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          ?>  
						  <button><a href="tia.php">Contnue to Cart</a></button>
