 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="shoppingcartc.php"</script>';  
           }  
      }  
      else  
      {  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="shoppingcartc.php?action=add&id=<?php echo $row["id"]; ?>">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="shoppingcartc.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
